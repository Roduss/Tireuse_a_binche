...
class Alcoolo_voiture_Screen extends State<Alcoolo_voiture_Form> {
            ...
            children: <Widget>[
              ...
              Row(
                children: <Widget>[
                  Expanded(
                    child: TextField(
                      decoration:
                          InputDecoration(hintText: "Deg d'alcool des binches"),
                      keyboardType: TextInputType.numberWithOptions(),
              ...
              Row(
                children: <Widget>[
                  Expanded(
                    child: TextField(
                      decoration: InputDecoration(hintText: "Ton poids"),
                      keyboardType: TextInputType.numberWithOptions(),
  ...
  String _CalcDegAlc() {
    ...
    if (alcool > 0.5) {
      result =
          'Ton degré d\'alcoolémie est de : $alcool g/L Il faut que tu sois à 0.5g/L grand fou ! Il faudra donc attendre $heure_conduite h avant de tchatcher la route proprement (0.5g/l)';
    } else {
      result =
          'Ton degré d\'alcoolémie est de : $alcool g/L, tu dois boire pour pouvoir espérer drifter un jour';
    }
